  ...
  return (
    <section className="text-gray-600 body-font bg-black relative flex">
      ...
      <div className="bg-black p-2 text-center mt-11 text-gray-300">
            <p>
              <ol className='text-xl text-left  '>
                ...
                <li className='p-2'>3. Una vez envies el  formulario te informaremos si esta disponible tu pelicula.</li>
                <li className='p-2'>4. Si tu pelicula esta disponible, hacemos la reserva y abonarás el precio al recogerla.</li>
                <li className='p-2'>5. Recuerda, tienes minimo 48h para disfrutarla.</li>
              </ol>
            </p>
      ...
      <div className="w-1/3 bg-gray-800 p-4 ml-auto mr-auto flex flex-col shadow-md">
        ...
        <button className="text-white bg-green-500 border-0 py-1 px-4 focus:outline-none hover:bg-green-600 rounded text-sm">
          Enviar
        </button>
