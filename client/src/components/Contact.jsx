...
const Contact = () => {
  ...
  return (
    <section className="text-gray-600 body-font bg-black relative flex flex-col lg:flex-row md:flex-row">
      <div className=" md:w-1/2 lg:w-1/2   bg-black flex justify-center">
        <div className="bg-black p-4 text-center mt-11 text-gray-300">
          
        <h2 className=' xl:text-xl xl:ml-14 sm:text-sm  text-left'>
              ...
              <p className='p-2'>3. Una vez envíes el formulario te informaremos si está disponible tu película.</p>
              <p className='p-2'>4. Si tu película está disponible, hacemos la reserva y abonarás el precio al recogerla.</p>
              <p className='p-2'>5. Recuerda, tienes mínimo 48h para disfrutarla.</p>
            </h2>
